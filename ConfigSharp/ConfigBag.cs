...
namespace ConfigSharp
{
    public class ConfigBag
    {
        ...
        public List<string> Functions = new() { AnyPublicMember };
        ...
        public static string LoadUri(string url)
        {
            ...
            try {
                ...
                code = client.GetStringAsync(url).Result;
            } catch (Exception ex) {
            ...
            if (compilationResult.Success) {
                ...
                foreach (var type in assemblyTypes) {
                    try {
                        ...
                        if (loadMethods == null || !loadMethods.Any()) { throw new Exception("No Load method"); }
